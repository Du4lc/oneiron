...
(function () {
  ...
  const DEFAULT_LOGO = window.ONEIRON_DEFAULT_LOGO || './assets/oneiron.png'; // fallback si no hay logo
  ...
  function renderCards() {
    ...
    Object.entries(store).forEach(([userKey, profile]) => {
      ...
      card.addEventListener('click', () => {
        ...
        window.location.href= `${VIEW_BASE}?user=${encondeURIComponent(userKey)}`
